...
CREATE TABLE internal_processed_event (
                                                        id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE internal_email_delivery (
                                                       id BIGSERIAL PRIMARY KEY,
                                                       event_id BIGINT NOT NULL,
                                                       order_id BIGINT NOT NULL,
...
CREATE TABLE product_sales_projection (
                                                        id BIGSERIAL PRIMARY KEY,
                                                        product_id BIGINT NOT NULL,
...
CREATE TABLE daily_sales_projection (
                                                      id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE daily_order_funnel_projection (
                                                             id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_product_scheduled_start
...
CREATE INDEX idx_product_history_changed_by_created
...
CREATE INDEX idx_orders_user_status_id
...
CREATE INDEX idx_orders_paid_status
...
CREATE INDEX idx_payment_attempt_reconciliation
...
CREATE INDEX idx_daily_sales_projection_date
    ON daily_sales_projection (sales_date DESC);

CREATE INDEX idx_daily_order_funnel_date
    ON daily_order_funnel_projection (order_date DESC);

CREATE INDEX idx_product_sales_projection_ranking
